...
function UIMiniWindowContainer.create()
    ...
    container.childReOrderEnabled = false -- Inicialização padrão
    return container
end
...
function UIMiniWindowContainer:reloadChildReorderMargin()
  self.childReorderMargin = self.childReorderMargin or 0
end

function UIMiniWindowContainer:isMainPanel()
  -- Retorna true ou false com base na lógica necessária
  return self.mainPanel or false
end


function UIMiniWindowContainer:isChildReOrderToggle()
  -- Retorna verdadeiro ou falso dependendo da lógica
  return self.childReOrderEnabled or false
end

function UIMiniWindowContainer:updateChildrenIndexStates()
  for _, child in pairs(self:getChildren() or {}) do
      child.indexState = child.indexState or 0
  end
end
