...
local function updateValueDisplay(widget)
	...
	if widget:getAutoHide() then
		if widget:getMinimum() == 0 and widget:getMaximum() == widget:getMinimum() then
			widget:hide()
		else
			widget:show()
		end
...
local function updateSlider(self)
	...
	if self.minimum == 0 and self.maximum == 0 then
		slider:setOpacity(0)
	else
		slider:setOpacity(1)
	end
...
function UIScrollBar:getAutoHide()
