...
function init()
  ...
  attackerButton = overlay:recursiveGetChildById('attacker')
  use = overlay:recursiveGetChildById('use')
  follow = overlay:recursiveGetChildById('follow')
  look = overlay:recursiveGetChildById('look')
  menuButton = overlay:recursiveGetChildById('menu')
  exitButton = overlay:recursiveGetChildById('exitgame')
  mountButton = overlay:recursiveGetChildById('buttonMount')
  bugButton = overlay:recursiveGetChildById('buttonBug')
  keypad = overlay:recursiveGetChildById('keypad')
  
    buttonChat = overlay:recursiveGetChildById('buttonChat')
  buttonChat:hide()
  ...
  attackerButton.onClick = function()	AttackMobile()	scheduleEvent(function() attackerButton:enable() end, 1000)	end
...
function onMobileButton(id, type)
  if id == 01 then
    return attackerButton
  end
end

function onHideUI(id)
  if id == 00 then
    mountButton:hide()
    bugButton:hide()
    attackerButton:hide()
